...
// MIEM_IO_ERROR_CODE_UNSUPPORTED_CALENDAR to keep v1 free of multi-calendar
// arithmetic.
//
// NetCDF I/O failures are raised as `MiemException` (IO category, caught at
// the public boundary).  This header does NOT include `<netcdf.h>` — the
