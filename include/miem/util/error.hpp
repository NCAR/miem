...
#define MIEM_CONFIGURATION_ERROR_CODE_INVALID_VERTICAL_PROFILE       6
#define MIEM_CONFIGURATION_ERROR_CODE_INVALID_DIAGNOSTIC_SELECTION   7
...
#define MIEM_VALIDATION_ERROR_CODE_INVALID_GRID_METADATA 4
#define MIEM_VALIDATION_ERROR_CODE_INCONSISTENT_GRID_METADATA 5
