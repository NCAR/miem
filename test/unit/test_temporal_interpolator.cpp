...
TEST(TemporalInterpolatorTest, LinearAtMidpoint)
{
  ...
  auto sr = t.SetBracket(0.0, 100.0, kLeft, kRight);
...
{
  TemporalInterpolator t(InterpolationMode::kLinear);
  ASSERT_TRUE(static_cast<bool>(t.SetBracket(0.0, 100.0, kLeft, kRight)));
...
{
  TemporalInterpolator t(InterpolationMode::kLinear);
  ASSERT_TRUE(static_cast<bool>(t.SetBracket(50.0, 50.0, kLeft, kRight)));
...
// ---------------------------------------------------------------------
// SetBracket with size mismatch -> CellCountMismatch
// ---------------------------------------------------------------------
TEST(TemporalInterpolatorTest, SetBracketSizeMismatchReturnsError)
{
  TemporalInterpolator t(InterpolationMode::kLinear);
  std::vector<Real> left  = { Real{ 1 }, Real{ 2 } };
  std::vector<Real> right = { Real{ 3 } };
  auto r = t.SetBracket(0.0, 100.0, left, right);
...
{
  TemporalInterpolator t(InterpolationMode::kLinear);
  ASSERT_TRUE(static_cast<bool>(t.SetBracket(10.0, 20.0, kLeft, kRight)));
